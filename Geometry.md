...
Unlike the implementation, this document is intended to remain stable as the project evolves. It records the mathematical architecture of the geometry library, independently of implementation details and future code refactoring.
